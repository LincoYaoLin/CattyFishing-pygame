...
win_image=pygame.image.load("image/happy8.png")
...
super_mineral_image = pygame.image.load('image/book_fish.png') if pygame.image.get_extended() else pygame.Surface((60, 40))
...
super_mineral_image = pygame.transform.scale(super_mineral_image, (130, 90))
...
def draw_victory():
    ...
    # draw_text("Catty Fishing", title_font, BLACK, screen, SCREEN_WIDTH // 2, 100, center=True)  # 添加标题
    victory_text = large_font.render("You Got The Target!", True, (204,0,0))
...
def draw_failure():
    ...
    # draw_text("Catty Fishing", title_font, BLACK, screen, SCREEN_WIDTH // 2, 100, center=True)  # 添加标题
    failure_text = large_font.render("OH NO Failure Fishing", True, (0,102,204))
